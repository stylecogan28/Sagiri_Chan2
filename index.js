...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:StyleCogan\n' // Nama kamu
            + 'ORG:Sagiri Chan;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6289509938750:+62 89509938750\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
if (text.includes('.tagme')) {
 ...
 const options = {
       text: `@${nomor.split("@s.whatsapp.net")[0]} Hai kaka sayang🤗`,
...
conn.sendMessage(id, '3aalaikumsalam, mau .menu/.info/atau aku Contoh .menu' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, mau .menu/.info/atau aku Contoh .menu' ,MessageType.text);
}
...
conn.sendMessage(id, 'iya sayang?, mau apa .menu/.info/atau aku Contoh .menu' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'iya sayang?, mau apa .menu/.info/atau aku Contoh .menu' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner sagiri wa.me/+6289509938750' ,MessageType.text);
}
else if (text == 'Agung'){
