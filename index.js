...
conn.sendMessage(id, 'Waalaikumsalam sayang, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
if (text == 'Assalamualaikum'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
if (text == 'p'){
conn.sendMessage(id, 'apa sayang?, mau .menu/.info/.donasi atau mau aku?:* Contoh .menu' ,MessageType.text);
}
if (text == 'P'){
conn.sendMessage(id, 'apa sayang?, mau .menu/.info/.donasi atau mau aku?:* Contoh .menu' ,MessageType.text);
}
